...
<html lang="en">
	...
	<body class="off-canvas-sidebar">
        ...
        <div class="full-page register-page" filter-color="black" data-image="{{ asset('img/register.jpg') }}">
            <div class="container">
                <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form class="form" method="post" action="{{ route('register') }}">
                                        ...
                                        <div class="footer text-center">
                                            <button type="submit" class="btn btn-primary btn-round btn-lg">Daftar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
